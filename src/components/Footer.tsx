...
const Footer = () => {
  return (
    <footer className="bg-club-dark text-white">
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-sm hover:text-club-primary">Home</Link>
              </li>
              <li>
                <Link to="/about" className="text-sm hover:text-club-primary">About Us</Link>
              </li>
              <li>
                <Link to="/events" className="text-sm hover:text-club-primary">Events</Link>
              </li>
              <li>
                <Link to="/gallery" className="text-sm hover:text-club-primary">Gallery</Link>
              </li>
              <li>
                <Link to="/contact" className="text-sm hover:text-club-primary">Contact</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/study-material" className="text-sm hover:text-club-primary">Study Material</Link>
              </li>
              <li>
                <Link to="/activities" className="text-sm hover:text-club-primary">Club Activities</Link>
              </li>
              <li>
                <a href="https://bce.ac.in" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-club-primary">
                  College Website
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-white/10 pt-8">
          <p className="text-center text-xs opacity-80">
            &copy; {new Date().getFullYear()} Campus TV and Radio Club. All rights reserved. BCE Bhagalpur.
          </p>
        </div>
      </div>
    </footer>
